...
// class myClass DOM을 찾아라. 
$('.myClass') //<div class='myClass'></div>

//name attribute value 가 surname 인 input DOM 들을 찾아라.
...
$('form :checkbox') // <input type='checkbox'/> 0보다 크면 참이고 0이면 거짓이다
